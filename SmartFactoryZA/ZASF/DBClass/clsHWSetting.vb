Public Class clsHWSetting
    ...
    Public Function selectForLHJByID(ws As String, id As String) As DataTable
        ...
        Dim dt As DataTable = DBacs.ExecuteSql(szSql, -1, g_factory_id, ws, g_equiptype_LHJ, "%" & id & "%")
        If IsNothing(dt) Then
    ...
    Public Function selectByType(ws As String, type As String) As DataTable
        Dim szSql As String = String.Empty
        szSql &= "SELECT * "
        szSql &= "  FROM sf.t_hw_setting "
        szSql &= "  WHERE factory_id =? "
        ...
        Dim dt As DataTable = DBacs.ExecuteSql(szSql, -1, g_factory_id, ws, type)
        If IsNothing(dt) Then
    ...
    Public Function saveGJB(IUType As String, oldgjb As entity_gjb, newgjb As entity_gjb) As Integer
        ...
        If IUType = INSERT_TYPE Then
            ...
            Try
                ...
                '电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， g_factory_id, g_ws_gjb, g_equipType_dzc, newgjb.dzc_id_text, newgjb.dzc_ip_text， newgjb.dzc_port_text, DBNull.Value, Now())
                '扫描枪1
        ...
        ElseIf IUType = UPDATE_TYPE Then
            ...
            Try
                ...
                szSql &= "set equip_id=?  , ip=? ,port=? ,update_time=?  "
                szSql &= "where factory_id=? and workshop_id=? and equip_type_id=? and equip_id=?"
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， newgjb.dzc_id_text， newgjb.dzc_ip_text， newgjb.dzc_port_text， Now(), g_factory_id, g_ws_gjb, g_equipType_dzc, oldgjb.dzc_id_text)
                '扫描枪1
                szSql = ""
                szSql &= "update sf.t_hw_setting "
    ...
    Public Function saveJP(IUType As String, oldjp As entity_jp, newjp As entity_jp) As Integer
        ...
        If IUType = INSERT_TYPE Then
            ...
            Try
                ...
                '电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， g_factory_id, g_ws_jp, g_equipType_dzc, newjp.dzc_id_text, newjp.dzc_ip_text， newjp.dzc_port_text, DBNull.Value, Now())
                '扫描枪
                ...
                '端片 电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， g_factory_id, g_ws_jp, g_equipType_dpdzc, newjp.dpdzc_id_text, newjp.dpdzc_ip_text， newjp.dpdzc_port_text, DBNull.Value, Now())
                '保护胶电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， g_factory_id, g_ws_jp, g_equipType_bhjdzc, newjp.bhjdzc_id_text, newjp.bhjdzc_ip_text， newjp.bhjdzc_port_text, DBNull.Value, Now())
                DBacs.CommitTransaction()
            Catch ex As Exception
                DBacs.RollbackTransaction()
            Finally
        ...
        ElseIf IUType = UPDATE_TYPE Then
            ...
            Try
                ...
                '电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， newjp.dzc_id_text， newjp.dzc_ip_text， newjp.dzc_port_text， Now(), g_factory_id, g_ws_jp, g_equipType_dzc, oldjp.dzc_id_text)
                '端片秤重电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， newjp.dpdzc_id_text， newjp.dpdzc_ip_text， newjp.dpdzc_port_text， Now(), g_factory_id, g_ws_jp, g_equipType_dpdzc, oldjp.dpdzc_id_text)
                '保护胶秤重电子秤
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， newjp.bhjdzc_id_text， newjp.bhjdzc_ip_text， newjp.bhjdzc_port_text， Now(), g_factory_id, g_ws_jp, g_equipType_bhjdzc, oldjp.bhjdzc_id_text)
                '扫描枪1
                szSql = ""
                szSql &= "update sf.t_hw_setting "
                szSql &= "set com=?  ,update_time=? "
    ...
    Public Function saveLHAGV(IUType As String, type As String, oldlh As entity_lhAgv, newlh As entity_lhAgv) As Integer
        Dim szSql As String = String.Empty
        Dim rtn As Integer
        Try
            ...
            If IUType = UPDATE_TYPE Then
                ...
                rtn = DBacs.ExecuteUpdateSql(szSql, -1，
                                                 newlh.id_text, newlh.ip_text， newlh.port_text,
                                                 newlh.status_text, newlh.deleted_text, newlh.type_name_text, Now(),
                                                 g_factory_id, g_ws_lh, type, oldlh.id_text)
            ...
            If IUType = DELETE_TYPE Then
                ...
                rtn = DBacs.ExecuteUpdateSql(szSql, -1， g_factory_id, g_ws_lh, type, newlh.id_text)
